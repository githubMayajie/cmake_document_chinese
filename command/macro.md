...
```<arg1>```, бн Commands listed after macro, but before the
...
first modified by replacing formal parameters (${arg1}, бн)
with the arguments passed, and then invoked as normal commands.
In addition to referencing the formal parameters you can reference the
values ${ARGC} which will be set to the number of arguments passed
into the function as well as ${ARGV0}, ${ARGV1}, ${ARGV2},
бн  which will have the actual values of the arguments passed in.
...
In a function, ARGN, ARGC, ARGV and ARGV0, ARGV1, бн
